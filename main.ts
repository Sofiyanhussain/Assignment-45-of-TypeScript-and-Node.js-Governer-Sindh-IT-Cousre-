...
let personName:String = "Sofiyan Hussain";
...
let namewitwhitespace:string = "\t \n Sofiyan hussain \t \n";
console.log(`name wit white space - ${namewitwhitespace}`);

let strippedname:string = namewitwhitespace.trim();
...
const names:string[] = ["Atta", "Arham", "Ahad", "Areez", "Ali", "Saim", "Asad", "Ahmed"];
...
const transportation:string[] = ["car", "motorcycle", "Bicycle", "bus",];
...
let Guestlist:string[] = ["Asad", "Ahmed", "Kamran"];
...
let unableguest:string = Guestlist.splice(2,1)[0];
...
let invitation:string[] = Guestlist;
let invitationCount:number = invitation.length;
...
let Placetovisit:string[] = ["Kyoto","Santorini","MachuPicchu"," Reykjavik"," CapeTown"];
...
let country:string[] = ["Pakistan", "India", "Afghanistan", "Albania", "Australia",];
...
let person: {name: string, fname: string, age: number} = {name: 'Sofiyan', fname: "Muzaffar", age:23}
console.log(person) ;
...
const weekdays:string[] = ["Sun", "Mon", "Tue", "Wed", "thus", "fri", "sat",];
...
let alien_color: string = "green"; // Assign the value 'green' to the alien_color variable.
...
let currentUsers : string[] = ["sofiyan", "Usman", "Ahmed", "Moiz", "admin"];
let newUsers : string[] = [" sofiyan", "Amna", "Maryam", "Asad","admin"];

let current_users_Lower : string[] = currentUsers.map(user => user.toLowerCase());
...
// Print each return value to show that Objects are storing the album information correctly. Add an optional parameter to make_album() 
...
let magicians: string[] = ["Hermione Granger", "Ron Weasley", "Harry Potter"];
